...
public class KuYunController {
    ...
    private static int update(PageGetUtil commonPageGet, File file, ProcessService processService,String baseurl,int startIndex,MovieESDao movieESDao){ {
...
//        System.err.println(movieListProcessService.processTotlePage(page));
        ...
        LogUtil.fileWriter(file,movie.toString());
//
//
