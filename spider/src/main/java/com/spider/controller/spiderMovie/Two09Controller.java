...
//
//    @Autowired
//    Two09MovieListProcessServiceImpl zd;
//
//
//    String baseurl = "http://www.1156zy.net";
//
//    static SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
//
//
//    //从第一页到pageIndex页更新
//    @ApiOperation(value = "209资源更新", notes = "209最大资源，startIndex起始页，endIndex终止页（不包括）")
//    @GetMapping("209/update/{startIndex}/{endIndex}")
//    public String updateMovie(@PathVariable(value = "startIndex") int startIndex, @PathVariable(value = "endIndex") int endIndex) {
//        File file = LogUtil.creatFile("./209资源更新日志.txt");
...
//
//    //从第一页到最后一页爬取
//    @GetMapping("209/climb/{pageIndex}")
//    public void climbMovie(@PathVariable(value = "pageIndex") int pageIndex) {
//        File file = LogUtil.creatFile("./209资源爬取日志.txt");
//        /*起始页数*/
//        int index = pageIndex;
//        while (true) {
...
//
//                int length1 = 0;
//                if (movie.getMc().getTwo09collectionm3u8() != null) {
//                    length1 = movie.getMc().getTwo09collectionm3u8().split(",").length;
//                }
//
//
//                int length = 0;
...
//                    }
//                }
//                length = byMovieNameLike.getMc().getTwo09collectionm3u8().split(",").length;
//                /*ES中不存在该电影，直接向MySql和Elasticsearch中添加该电影*/
//                if ("".equals(byMovieNameLike.getMovieName()) && "".equals(byMovieNameLike.getMc().getTwo09collectionm3u8())) {
