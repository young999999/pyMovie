...
public class ZuiDaController {
    ...
    String baseurl = "http://www.zuidazy4.com";
...
//                LogUtil.fileWriter(file, sdf.format(System.currentTimeMillis()) + ":添加电影id=" + movie.getMovieId() + "：" + movie.getMovieName());
            ...
            /*ES中存在该电影*/
                ...
                if (length1 > length||"".equals(byMovieNameLike.getMc().getZdcollectionm3u8())) {
                    ...
                    UpdateControllerutil controllerutil=new UpdateControllerutil(movieESDao,movieMapper,movie,file,name,"zd");
                    controllerutil.setName("最大");
...
//                        System.err.println(sdf.format(System.currentTimeMillis()) + ":更新电影（剧集改变）id=" + byMovieNameLike.getMovieId() + "：" + movie.getMovieName());
                        ...
                        System.out.println(sdf.format(System.currentTimeMillis()) + "\t最大:该电影存在id=" + byMovieNameLike.getMovieId() + "：" + movie.getMovieName());
...
//            System.out.println(sdf.format(System.currentTimeMillis()) + ":第" + startIndex + "页完成");
    ...
    public static void main(String[] args) throws IOException {
        ...
        String url = "http://www.zuidazy4.com/?m=vod-detail-id-79488.html";
//        String url = "http://www.zuidazy4.com/?m=vod-index-pg-888.html";
